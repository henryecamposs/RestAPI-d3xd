...
{
    public class Facturas : ICloneable
    {
        ...
        private DateTime mFechaFactura = new DateTime(2000, 01, 01);
        ...
        private int mNroFactura = 0;
        private string mNroFacturaIF = "";
        ...
        Facturas(int ID, int Id_Caja, int Id_Cliente, int id_corteZ, int Id_Empleado, int Id_Estaciones_Sesiones, int id_defTipoSatusFactura, DateTime FechaActual, DateTime FechaFactura, double MontoTotal, double MontoTotalBase, double MontoTotalIVA, double MontoTotalDescuento, int NroItems, int NroFactura, string NroFacturaIF, string Comentarios, bool esDevolucion, int id_Sucursal)
        {
            mID = ID;
            mId_Caja = Id_Caja;
