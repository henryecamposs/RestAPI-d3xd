...
{
    public class Clientes_Ret_IVA : ICloneable
    {
        ...
        private double mMontoRetencionIVA = 0.0;
        private int mNroDocumentos = 0;
        ...
        public Double MontoRetencionIVA
        {
            get
            {
                return mMontoRetencionIVA;
            }
            set
            {
                mMontoRetencionIVA = value;
            }
        }
        ...
        Clientes_Ret_IVA(int ID, int id_Cliente, int id_Estaciones_Sesion, int id_defTipoDocumento, int id_defTipoImpresion, string NroDocumento, double MontoBase, double MontoIVA, double MontoExento, double MontoBaseRetencion, double MontoRetencionIVA, int nroDocumentos, DateTime FechaEmision, bool esEnEspera)
        {
            mID = ID;
            ...
            mMontoRetencionIVA = MontoRetencionIVA;
            mNroDocumentos = NroDocumentos;
