...
{
    public class REDONDEO : ICloneable
    {
        ...
        REDONDEO(double FDECIMAL, double FENTERO, int ID, double MODDEC, double MODENT, double UNIDAD, double VALREDDEC, double VALREDENT, double VALREDTOT)
        {
            mFDECIMAL = FDECIMAL;
            mFENTERO = FENTERO;
            mID = ID;
