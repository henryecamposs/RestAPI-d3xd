...
{
    public class ESTACION_PLANTILLA_PRODUCTO : ICloneable
    {
        ...
        ESTACION_PLANTILLA_PRODUCTO()
        {
        }

        ESTACION_PLANTILLA_PRODUCTO(double CAMPO, string DESCR, double FILTRO, int ID, double ID_CAMPO, double ID_PLANTI, double ID_TABLA, double KEY, double KEYDES)
        {
            mCAMPO = CAMPO;
            mDESCR = DESCR;
            mFILTRO = FILTRO;
