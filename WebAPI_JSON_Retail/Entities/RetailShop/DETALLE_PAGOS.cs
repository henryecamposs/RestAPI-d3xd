...
{
    public class DETALLE_PAGOS : ICloneable
    {
        ...
        DETALLE_PAGOS(string BANCO, string CAJA, string CEDU, double CHEQUE, string CODIGO, double CODMON, double COD_VAL, double COM_PVB, double DONACION, string EMISOR, string EMPLE, string EXPIRA, DateTime FECHA, string FECHAC, string ID, int IDSUC, int ID_BANCO, int ID_CUSTO, int ID_DETPA, int ID_DOCU, int ID_PVB, double ISLR_PVB, double MONTO, double MON_CONV, double NRO, double PORC, double PROPI, double RECIBIDO, double SALDO_FAV, double SESION, string TELE, string TIPO, string TIPOD, string UIDCORTE, string UIDFAC, double VAUCHE)
        {
            mBANCO = BANCO;
            mCAJA = CAJA;
            mCEDU = CEDU;
