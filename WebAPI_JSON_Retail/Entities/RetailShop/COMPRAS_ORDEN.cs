using System; namespace wResAPI_d3xd.Entities.RetailShop
{
    public class COMPRAS_ORDEN : ICloneable
    {
        ...
        private DateTime mFPAGO = new DateTime(2000, 01, 01);
        private DateTime mFPROC = new DateTime(2000, 01, 01);
        ...
        COMPRAS_ORDEN(double BASE1, double BASE2, double BASE3, double CANCELA, double DES1, double DES2, double DES3, double DES4, double DES5, double DES6, double DESCU, double DESCU1, double DESCU2, double DESCU3, double DESCU4, double DESCU5, double DESCU6, double DEVOLU, string DIRECCION, string ESTADO, double EXENTO, DateTime FECHA, string FECHAC, DateTime FECHAV, DateTime FPAGO, DateTime FPROC, DateTime F_RETEN, double GASTO1, double GASTO2, double GASTO3, double GASTOF1, double GASTOF2, double GASTOF3, double GASTOF_EXE, double GASTO_EXE, int ID, int IDSUC, int ID_RETEN, double IMP1, double IMP2, double IMP3, double IMPUESTOA, double IMP_GAS1, double IMP_GAS2, double IMP_GAS3, double IMP_GASF1, double IMP_GASF2, double IMP_GASF3, double IVA, double MONTO, string NIT, string NOMBRE, double NRO, string NROC, string NRORETEN, double PDESCU, double POR_DESG, string PROVEE, int PROVEEID, string RIF, double TAX1, double TAX2, double TAX3, double TDES1, double TDES2, double TDES3, double TDES4, double TDES5, double TDES6, string TELE, double TIPOD, double TOTAL, string UID)
        {
            mBASE1 = BASE1;
            mBASE2 = BASE2;
            mBASE3 = BASE3;
