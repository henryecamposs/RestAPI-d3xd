<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmVerificador.aspx.cs" Inherits="WebAPI_JSON_Retail.frmVerificador" %>
            ...
            <tr>
                <td class="clear" colspan="2">
                            <table  style="width: 100%; height: 100%">
                                <tr>
                                    <td align="right"   colspan="3" class="EncabezadoTabla">Consultar Producto</td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="right" colspan="3" style="vertical-align: middle; text-align: left">
                                        <asp:Panel ID="Panel2" runat="server" Height="266px">
                                            <table align="center" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                                <tr style="padding: 5px; vertical-align: middle; text-align: center; " ><td colspan="2" class="auto-style30">
